...
files = ['%s/20220801_%s_vwl1_pwl1_hr1.44e+02_nh35000_orgfn1_inorg1__gc.dat'%(output_dir,identify)]
...
for file in files:
  ...
  df1 = df1.rename(colums={0: 'Date/Time'})
  
  df2 = pd.DataFrame(sulf)
  df2 = df2.rename(colums={0: 'Sulfuric Acid [molec./cm^3]'})
