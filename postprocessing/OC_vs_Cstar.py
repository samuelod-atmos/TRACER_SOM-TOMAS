...
spec_file = '%s/20220801_%s_db%s_pwl%s_vwl%s_OH%s_FN%s_HOM%s_T%s_RH%s_spec.dat'%(output_dir,
    identify,
    str(db),
    str(pwl),
    str(vwl),
...
for som_grid in som_grids:
  ...
  #plt.scatter(OC_ts,Cstar)
  plt.scatter(Cnum,Cstar)
  #plt.scatter(Onum,Cstar)

  #plt.title('C* vs Oxygen #')
  #plt.title('C* vs O:C')
  plt.ylabel('Cstar [ug/m^3]')
  plt.xlabel('Numer of Oxygens')
  #plt.xlabel('O:C')
  plt.yscale('log')
