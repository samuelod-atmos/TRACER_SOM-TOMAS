...
files = [
  '%s04272016_%s_Cstar%s_T287.62_NH35.00e+03_nlay20_hr1.00e+01_ricco1_dunn1_bg10_hom.dat'%(output_dir,run,cstar),
  '%s04282016_%s_Cstar%s_T285.89_NH35.00e+03_nlay20_hr1.00e+01_ricco1_dunn1_bg10_hom.dat'%(output_dir,run,cstar),
  '%s05112016_%s_Cstar%s_T293.72_NH35.00e+03_nlay20_hr1.00e+01_ricco1_dunn1_bg10_hom.dat'%(output_dir,run,cstar),
  '%s05142016_%s_Cstar%s_T282.61_NH32.00e+03_nlay20_hr1.00e+01_ricco1_dunn1_bg10_hom.dat'%(output_dir,run,cstar),
]
#files = [
...
#  print('temps =',temps)
  ...
  print('Initial shape of HOM array:',np.shape(saprc_oh))
  saprc_oh = np.reshape(saprc_oh, (Time.shape[0]-1,nlayers,2))
  print('shape of HOM array:',np.shape(saprc_oh))
...
#  print('saprc_oh[:,layer-1,1] =',saprc_oh[:,layer-1,1])
 ...
 # x = np.linspace(0,len(OH),len(OH))
  ...
  plt.ylabel('HOM [kg]')
  plt.title('HOM - %s/%s/%s'%(month,day,year)) 
