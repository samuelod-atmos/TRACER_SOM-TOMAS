...
C-----INPUTS------------------------------------------------------------
      ...
      double precision nh3_ppt                 ! concentration of ammonia [molec cm-3]
      double precision NH3MOLEC_CM3         ! concentration of ammonia [molec cm-3]
...
C-----ADJUSTABLE PARAMETERS---------------------------------------------
      ...
      read(*,'(F8.5)') tempi
      print*,'tempi =',tempi
      write(*,*) 'Enter fion [#/cm^3]'
      read(*,'(F15.4)') FION ! [cm-3 s-1]
      print*,'FION =',FION
      write(*,*) 'Enter sulfuric acid [molec/cm^3]'
      read(*,'(F15.4)')cnai
      print*,'cnai =',cnai
      write(*,*) 'Enter NH3 [ppt]'
      read(*,'(F15.4)')nh3_ppt
...
C-----CODE--------------------------------------------------------------
      ...
      NH3MOLEC_CM3 = NH3_ppt*1.E-12*pres*6.022E23/17.03/tempi/R*1.e-6
      print*,'NH3MOLEC_CM3 =',NH3MOLEC_CM3  
      temp=tempi
      nh3=NH3MOLEC_CM3*1E-6 ! I think they want it in units of 1E6 molec cm-3
      cna=cnai*1E-6
      fion=fioni
      !Mair=Mairi
