...
C     Nkf, Mkf - same as above, but final values
      ...
      SUBROUTINE ezmass(Nki,Mki,mcondi,spec,Nkf,Mkf)
...
c      enddo
      ...
      call getMassSink(Nk1,Mk1,spec,CS,sinkfrac) ! set Nnuc to zero for this calc
